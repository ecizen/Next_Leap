...
const Step2PersonalExperience = ({
  ...
  return (
    <div className="w-full">
      <div className="border-l-4 rounded-xs border-l-purple-600 px-2">
      ...
      <div className="flex flex-col gap-y-5 mt-5">
        ...
        <div className="mt-6 border-l-4 rounded-xs border-l-purple-600 px-2">
        ...
        <div>
          ...
          <div
            {...getRootProps()}
            className={`border-2 border-dashed hover:border-purple-600 p-4 h-[200px] bg-gray-50 flex flex-col items-center justify-center rounded text-xs text-center cursor-pointer ${
